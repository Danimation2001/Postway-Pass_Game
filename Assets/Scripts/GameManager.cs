...
public class GameManager : MonoBehaviour
{
    ...
    public void GameOver()
    {
        ...
        gameOver = true;
        Conductor.instance.musicSource.Stop();
        GameObject gameOverUI = GameObject.Find("Game Over UI");
        gameOverUI.GetComponent<CanvasGroup>().alpha = 1;
        gameOverUI.GetComponent<CanvasGroup>().interactable = true;
        gameOverUI.GetComponent<CanvasGroup>().blocksRaycasts = true;
