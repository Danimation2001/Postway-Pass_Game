...
namespace FIMSpace
{
    public partial class LeaningProcessor
    {
        ...
        void UpdateRoot() // Root transform rotation animation -----------------------------
        {
            ...
            footOriginBone.RotateBy(forwardRotation * RootForwardSway * RootBlend * effectsBlend * AllEffectsBlend, 0f, sideRotation * RootBlend * effectsBlend * AllEffectsBlend);
        ...
        void UpdateSpine()
        {
            ...
            {
                // Side
                Vector3 startSpineRotOffset = SpineRightSway * targetSideRot * effectsBlend * AllEffectsBlend;
                startSpineRotOffset.x += SpineSideLean * Mathf.Abs(targetSideRot) * effectsBlend * AllEffectsBlend;
                ...
                spineStartBone.RotateByDynamic(tgtRotOffs * SpineBlend * AllEffectsBlend, 1f);

                // Forward
                Vector3 additionalRotOffsets = (SpineForwardSway * smoothTargetSpineRot + ConstantAddRotation) * effectsBlend * AllEffectsBlend * SpineBlend;
                ...
                if (neckBone != null)
                {
                    Vector3 neckCompensRotOffset = (SpineForwardSway * NeckCompensation * SpineBlend * -smoothTargetSpineRot - ConstantAddRotation) * effectsBlend * AllEffectsBlend;
