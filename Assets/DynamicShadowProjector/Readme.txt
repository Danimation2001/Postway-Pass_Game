Dynamic Shadow Projector version 1.2.2

[Unsupported Unity Versions]
The following versions of Unity are not supported. Shaders of which the names start with "DynamicShadowProjector/Projector/Dynamic/" may not work in an application built with those Unity Editor.
